...
class TrainOptions(BaseOptions):
    def initialize(self, parser):
        ...
        parser.add_argument('--lr', type=float, default=0.00015, help='initial learning rate for adam')
        parser.add_argument('--lr_D', type=float, default=0.00015, help='initial learning rate for adam')
